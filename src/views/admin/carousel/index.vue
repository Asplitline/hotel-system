<template>
  <el-card class="carousel">
    ...
    <el-table :data="tableData" style="width: 100%" max-height="650px">
      ...
      <el-table-column prop="originalFileName" label="标题" min-width="150"> </el-table-column>
      ...
      <el-table-column label="操作" min-width="100">
        <template v-slot="{ row }">
          ...
          <el-link type="danger" @click="deleteById(deleteShopFile, fetchCategory, row.id, '轮播图')">删除轮播图</el-link>
        </template>
      </el-table-column>
    </el-table>
    <el-dialog
      :originalFileName="carouselForm.flag === 0 ? '添加轮播图' : '修改轮播图'"
      :visible.sync="dialogVisible"
      width="30%"
      class="a-dialog"
      @close="clearDialog('carouselForm')"
