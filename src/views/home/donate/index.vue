	...
	<div class="donate">
		...
		<el-form :model="donateForm" ref="donateForm" :rules="donateRules">
			...
			<el-form-item label="捐赠标题" prop="name">
				<el-input type="textarea" v-model="donateForm.name" placeholder="捐赠标题">
				</el-input>
			</el-form-item>
			<el-form-item label="捐赠说明" prop="description">
				<el-input type="textarea" v-model="donateForm.description" placeholder="想说的话">
				</el-input>
			</el-form-item>
			<el-form-item label="捐赠内容" prop="comment">
				<el-select v-model="donateForm.comment" multiple style="width:100%;">
					<el-option :label="i.name" :value="i.name" v-for="i in allItem" :key="i.id">
					</el-option>
				</el-select>
			</el-form-item>
			<el-form-item label="捐赠类型" prop="source">
				<el-select v-model="donateForm.source" style="width:100%;">
					<el-option :label="i.text" :value="i.text" v-for="i in source" :key="i.id">
					</el-option>
				</el-select>
			</el-form-item>
		</el-form>
