export const SERVER_URL =
  process.env.VUE_APP_ENV === "development" ? "/api" : "http://127.0.0.1:8088";
// export const FILE_PREFIX = 'http://127.0.0.1:8088/images/'
...
export const levelInfo = [
  ...
  { flag: 1, value: "员工", type: "primary" },
  { flag: 2, value: "管理员", type: "danger" },
];
...
export const procureOrderState = [
  { value: 0, label: "审核中", type: "primary" },
